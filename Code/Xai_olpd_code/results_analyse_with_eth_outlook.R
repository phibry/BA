...
load("C:/Users/buehl/Desktop/PA_BA/BA/data/BTC_USD_03_06_21.rda")
load("C:/Users/buehl/Desktop/PA_BA/BA/data/log_ret_03_06_21.rda")



outtarget=log_ret_27_03_21["2020-07-01::2021-05-31"]
...
outtarget_eth=logret_eth["2020-07-01::2021-05-31"]
...
load(paste("data/xai/7_7_withsignal_xai_in_outlook/9",data_string,".rda",sep=""))
...
return_eth=diff(ETH$`ETH-USD.Close`)["2020-07-01::2021-05-31"]
return_btc=diff(BTC_USD$`BTC-USD.Close`)["2020-07-01::2021-05-31"]
...
cbind(cumsum(olpd_2_eth),cumsum(outtarget))

plot(cbind(cumsum(olpd_2_eth),cumsum(outtarget)))
