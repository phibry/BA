...
```{r xai_acf, fig.align='center', echo=FALSE, fig.cap="Autocorrelation function of BTC/USD.", out.width="80%", fig.width = 7, fig.height = 5}
# Load Data
...
```{r xai_plot1, fig.align='center', echo=FALSE, fig.cap="LPD compared to log returns of BTC.", out.width='100%', fig.width = 11, fig.height = 8.5}
# Load Data
par(mfrow=c(2,1))
...
kbl(df, caption="Comparison between linear regression (LR) and linear parameter data (LPD) coefficients.", booktabs = T, linesep = "") %>%
  kable_styling(latex_options = c("hold_position")) %>%
...
- Volatile Phasen -> instabile Netzwerke, könne möglicherweise als Signal genutzt werden, wird in Kapitel 3.3. etwas genauer untersucht.
...
In this section, bitcoin as a cryptocurreny is introduced by analyzing and commenting historical events. Further the technology in and around cryptocurrencies in chapter [2.3.2.](#bitcoin_tec) is briefly explained. This chapter serves to get an overview of the technology and background of bitcoin. A more detailed description is beyond the scope of this thesis and will therefore be refrained from. We work with the short form 'BTC', which is the abbreviation for the currency. 
...
```{r price_btc, out.width='75%', fig.cap='BTC/USD', echo=FALSE, fig.keep='last', fig.width = 8, fig.height = 5}
# knitr::include_graphics("images/logbtc_usd.jpeg")
load("data/BTC_USD_27_03_21.rda") 
...
```{r logprice_btc, out.width='75%', fig.cap='Logarithmic BTC/USD', echo=FALSE, fig.keep='last', fig.width = 8, fig.height = 5}
# knitr::include_graphics("images/btc_usd.jpeg")
