...
## 1####
iter <- 1
data_obj <- data_function(x=logret, lags=6, in_out_sep=dates_mat[iter,][2], start=dates_mat[iter,][1], end=dates_mat[iter,][3])
...
nn_10_3_50_1 <- nn_nl_comb_sharpe_mse(maxneuron=10,
                                      ...
                                      real=50,
                                      data_obj=data_obj)
# save(nn_10_3_50_1, file = "data/batch_4/nn_10_3_50_1.rda") # 16.26min
...
nn_10_3_50_2 <- nn_nl_comb_sharpe_mse(maxneuron=10,
                                      ...
                                      real=50,
                                      data_obj=data_obj)
# save(nn_10_3_50_2, file = "data/batch_4/nn_10_3_50_2.rda") # 16.47min
...
nn_10_3_50_3 <- nn_nl_comb_sharpe_mse(maxneuron=10,
                                      ...
                                      real=50,
                                      data_obj=data_obj)
# save(nn_10_3_50_3, file = "data/batch_4/nn_10_3_50_3.rda") # 17.0min
...
nn_10_3_50_4 <- nn_nl_comb_sharpe_mse(maxneuron=10,
                                      ...
                                      real=50,
                                      data_obj=data_obj)
# save(nn_10_3_50_4, file = "data/batch_4/nn_10_3_50_4.rda") # 1h 17min
...
nn_10_3_50_5 <- nn_nl_comb_sharpe_mse(maxneuron=10,
                                      ...
                                      real=50,
                                      data_obj=data_obj)
# save(nn_10_3_50_5, file = "data/batch_4/nn_10_3_50_5.rda") # 1h 23min
...
nn_10_3_50_6 <- nn_nl_comb_sharpe_mse(maxneuron=10,
                                      ...
                                      real=50,
                                      data_obj=data_obj)
# save(nn_10_3_50_6, file = "data/batch_4/nn_10_3_50_6.rda") #2h 13min
...
nn_10_3_50_7 <- nn_nl_comb_sharpe_mse(maxneuron=10,
                                      ...
                                      real=50,
                                      data_obj=data_obj)
# save(nn_10_3_50_7, file = "data/batch_4/nn_10_3_50_7.rda") # 48.733min
...
nn_10_3_50_8 <- nn_nl_comb_sharpe_mse(maxneuron=10,
                                      ...
                                      real=50,
                                      data_obj=data_obj)
# save(nn_10_3_50_8, file = "data/batch_4/nn_10_3_50_8.rda") # 1.18h
...
nn_10_3_50_9 <- nn_nl_comb_sharpe_mse(maxneuron=10,
                                      ...
                                      real=50,
                                      data_obj=data_obj)
# save(nn_10_3_50_9, file = "data/batch_4/nn_10_3_50_9.rda") # 2.88h
