...
```{r results_different_decisions, fig.align='center', out.width='100%', fig.cap="Neural network LPD results",dev = "svg",echo=FALSE}
knitr::include_graphics("images/xailpd/lambda_1_5_with0_5/all.svg")
```
