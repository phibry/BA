...
lpd signal(\sigma pred_{t}) =
\begin{cases} 
                                              
  0      & \quad \text{if } ,  \sigma pred_{t} \ge \sigma_{historical} \\
  1      & \quad \text{else}
...
$sigmapred_{t}$ = predicted volatility in every $_{t}$
...
```{r with_eth, fig.align='center', out.width='100%', fig.cap="Added Eth signal",dev = "tikz",echo=FALSE}
