...
#### 3.3.5. NN and LPD Trading
&nbsp;

In section [3.2.5](#mod-select) we have decided to fix the architecture 7 layers 7 nets, all
...
$\hat{garch}_{t}$ = GARCH signals $\in$ {$0,1$} from section [3.3.4](#garch-signal)
...
Let's have a simple theoretical comparison example under the assumptions in [3.3.](#trading-strat) at last.
