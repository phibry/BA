...
For  a closer analysis lets have a look at the best performing model in Figure \ref{fig:with_eth_sole}
...
events <- xts(LETTERS[1:5], as.Date(c("2020-08-01","2020-09-05","2021-01-14","2021-02-21","2021-03-12")))

#plots
addEventLines(events,srt=90,pos=2,lty=3,col = rep("#004c6d",5),lwd=2,)
