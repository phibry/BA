...
A theoretical investment of USD 1'000 is made at 2020-07-01, which is also the first date in figure \ref{fig:with_eth_sole}. A buy-and-hold strategy would result in a value of USD 6003.25 by the end of March 2021. However if we invest the 1000 USD in the best performing strategy we will end up with USD **11'633.70**  USD, which is nearly double the amount achieved with buy-and-hold. Comparing the Sharpe ratios of the LPD+NN+ETH (**4.41**) to buy-and-hold (3.57), the used strategy does also significantly better.
