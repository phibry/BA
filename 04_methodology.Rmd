...
NN is simply trading the forecast of the neural net, based on their sign.

NN+LPD is the performance as described in section [3.3.3](#lpd-signal). The combination NN+LPD+GARCH takes into account the GARCH signals from section [3.3.4](#garch-signal). If the  LPD or GARCH signal is 0 then the signal is also 0. 
