...
- Trotz unregelmässiger Qualität der Predictions werden wir uns trotzdem auf eine Architektur einigen müssen.  
...
When looking at the Sharpe ratios, an inverse relationship between the in-sample and out-of-sample can be seen. The in-sample Sharpe ratio improves in most time splits with increasing complexity. In the out-of-sample, however, the medians decrease. It can also be seen that some of the Sharpe ratios show periodic spikes again. Apart from these aspects, no clear patterns or correlations could be identified. To put these number into perspective, an one-time investment in the S&P 500 PR ten years ago would have resulted in a Sharpe ratio of 0.83.
...
- Overview flowchart erstellen und Beschreibung 
- Erklären, welche Faktoren eine Rolle spielen bei unserer Trading Strategie

#### 3.3.1. Explainable artificial intelligence (XAI)

- Begriffseinführung
- Grosses Themengebiet in allen AI Applikationen
...
- Aufzeigen, warum uns GARCH weiterhelfen könnte
- Gibt Zeichen, falls die Volatilität zu t+1 grösser ausfallen sollte. 
- In Signal umwandeln, falls z.B. signifikant grösser
