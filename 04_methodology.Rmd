...
#### 3.3.1. Trading with Neural Net and LPD 
...
Let $p$ be the predicted value of the neural net in a certain time $_{t}$.
...
For further evaluation of nets $\beta$ can be used as an optimizing factor.
...
```{r results_different_decisions, fig.align='center', out.width='100%', fig.cap="Nets LPD results", echo=FALSE}
knitr::include_graphics("images/xailpd/xai with insignal/devi_1_all3.jpeg")
```
