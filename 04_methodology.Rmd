...
That said, we use a simple rule to integrate ether. if the signal of the combination nn+lpd is 0 -> go long on ether, as soon as the signal from lpd changes back to 1 or -1 , ether is sold.

In figure \ref{fig:with_eth} we observe the outperforming of buy and hold, by adding the ether rule to the previous nn+lpd combinations.

&nbsp;

```{r with_eth, fig.align='center', out.width='100%', fig.cap="Added Eth signal",echo=FALSE, fig.width = 8, fig.height = 5, fig.keep='last'}
