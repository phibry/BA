...
load("data/log_ret_13_03_21_sd.rda");log_ret_sd= log_ret_13_03_21_sd# loading logreturns standardized by arma(0,10)-garch(1,1)
load("data/log_ret_13_03_21.rda");log_ret=    log_ret_13_03_21   # loading logreturns
ts.plot(log_ret)
```
