...
$\underline{Y}_{t}$ = Vector of in-sample LPD {$Y_{t}..Y_{lag_{n}}$} observed for every t

$\underline{X}_{t}$ = Vector of out-of-sample LPD {$X_{t}..X_{lag_{n}}$} predicted for every t
