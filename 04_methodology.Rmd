...
```{r test_train, out.width='80%', fig.cap='In- and out-of-sample splits.', echo=FALSE}
...
```{r lpd_explain, fig.align='center', out.width='100%', fig.cap="LPD Plot for illustration", echo=FALSE}
...
```{r lpd_explain_sum, fig.align='center', out.width='100%', fig.cap="LPD Sum Plot for illustration", echo=FALSE}
...
```
```{r with_eth_sole, fig.align='center', out.width='100%', fig.cap="Added Eth signal",dev = "svg",echo=FALSE,fig.keep="last"}
...
# 
# name=c(paste("Buy and Hold"," sharpe=3.57"),paste("nn+lpd+eth-if-0 β=0.2"," sharpe=4.41"))
# 
# class(data)
# plot(data[,c(1,5)], col=colors, main=main)
# 
# addLegend("topleft",
#           legend.names=name,
#           col=colors,
...
# 
# #plots
# addEventLines(events,srt=90,pos=2,lty=3,col = rep("#004c6d",6),lwd=2,)
# 
# 
# 
# 
