...
one can observe in $f()$ how the uncertain decidings result in a 0 signal. You could also use postions sizing and adjust the signal depending on the size of $\beta$ . But we have omitted this aspect, because otherwise there are too many parameters in the model.
...
For the calcula
In the same manner as before, for every $k$ of the $N_{total}$ network in every time step $t$ the derivative as in section [2.2.2](#xai_finance) is calculated. 
...
```{r lpd_explain, fig.align='center', out.width='80%', fig.cap="LPD Plot for illustration", echo=FALSE, fig.width = 8, fig.height = 5, fig.keep='last'}
...
```{r lpd_explain_sum, fig.align='center', out.width='80%', fig.cap="LPD Sum Plot for illustration", echo=FALSE, fig.width = 8, fig.height = 5, fig.keep='last'}
