...
the 9 splits which were in chapter [3.2.1.](#test_train) introduce are now used for trading. the out of sample performacenes of every split are added togheter and compared withc the benchmark
