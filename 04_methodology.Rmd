...
The reason for choosing this time windows lies in the fact that we do not believe that the historical data longer than a year ago consists of any information about the price of the following day. By optimizing our models we found that more data would bring no additional performance, therefore the selected subset is considered sufficient.
...
=======
We are looking for an optimal network, which should also provide reasonable and reliable predictions for different periods. For further analysis, we are using a subset of the introduced closing prices of bitcoin and their logreturns.
Starting from the first of January 2020 to the 27th of March in 2021, we only consider 15 months from the dataset.
