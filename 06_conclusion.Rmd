...
The GARCH model is only 1 of the many classical approaches for timeseries. Based on this thesis other tools such as different moving averages or  ARMA-APARCH Models in combination with feed forward nets.
